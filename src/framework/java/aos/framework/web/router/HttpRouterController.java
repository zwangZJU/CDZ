...
public class HttpRouterController {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			commonLogsPO.setContent(e.getTargetException().getMessage());
			commonLogsPO.setOper_id("HttpRouterController:Exception");
			commonLogsPO.setOper_name("HttpRouterController");
