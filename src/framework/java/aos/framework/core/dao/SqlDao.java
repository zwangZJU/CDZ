package aos.framework.core.dao;
...
import aos.framework.core.exception.ProcedureException;
...
public class SqlDao extends SqlSessionDaoSupport {
	...
	public void call(String sqlId, Dto procDto){
		...
		if (AOSUtils.isNotEmpty(procDto.getAppCode())) {
			if (!StringUtils.equals(procDto.getAppCode(), AOSCons.PROC_SUCCESS)) {
	 ...
	 * 
	 * @see aos.framework.core.dao.asset.DBType
	 * @return
	 */
