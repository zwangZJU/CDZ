...
public class RequestHandler2 {
	 ...
	 * @return
	 */
	public RequestHandler2(HttpServletRequest request,
...
//		System.out.println("UrlEncode后 packageValue=" + packageValue);
	...
	public String createSign(SortedMap<String, String> packageParams) {
		...
		String sign = MD5Util2.MD5Encode(sb.toString(), this.charset)
				.toUpperCase();
	...
	public boolean createMd5Sign(String signParams) {
		...
		String enc = TenpayUtil2.getCharacterEncoding(this.request,
				this.response);
		String sign = MD5Util2.MD5Encode(sb.toString(), enc).toLowerCase();
