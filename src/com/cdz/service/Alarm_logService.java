...
public class Alarm_logService extends CDZBaseController {
	...
	public void receive_alarmAlarm_log(HttpModel httpModel) {
		...
		//Basic_userPO basic_userPO = basic_userDao.selectByAccount(alarm_logPO1.getUser_phone());
		//newDto.put("user_address", basic_userPO.getUser_address());
		//newDto.put("user_name", basic_userPO.getUser_name());
