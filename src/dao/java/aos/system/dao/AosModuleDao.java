...
public interface AosModuleDao {
	 ...
	 * @return 返回影响行数
	 */
	int insert(AosModulePO aos_modulePO);
	 ...
	 * @return 返回影响行数
	 */
	int insertAll(AosModulePO aos_modulePO);
	 ...
	 * @return int 返回影响行数
	 */
	int updateByKey(AosModulePO aos_modulePO);
	 ...
	 * @return AosModulePO
	 */
	AosModulePO selectByKey(@Param(value = "id_") String id_);
