...
import aos.system.dao.AosRoleModulePO;
...
public interface AosRoleModuleDao {
	 ...
	 * @return 返回影响行数
	 */
	int insert(AosRoleModulePO aos_role_modulePO);
	 ...
	 * @return 返回影响行数
	 */
	int insertAll(AosRoleModulePO aos_role_modulePO);
	 ...
	 * @return int 返回影响行数
	 */
	int updateByKey(AosRoleModulePO aos_role_modulePO);
	 ...
	 */
	AosRoleModulePO selectByKey(@Param(value = "id_") String id_);
