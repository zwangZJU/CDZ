...
public interface AosParamsDao {
	 ...
	 * @return 返回影响行数
	 */
	int insert(AosParamsPO aos_paramsPO);
	 ...
	 * @return 返回影响行数
	 */
	int insertAll(AosParamsPO aos_paramsPO);
	 ...
	 * @return int 返回影响行数
	 */
	int updateByKey(AosParamsPO aos_paramsPO);
	 ...
	 * @return AosParamsPO
	 */
	AosParamsPO selectByKey(@Param(value = "id_") String id_);
