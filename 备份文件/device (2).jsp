...
<aos:onready>
		...
		<aos:formpanel id="_f_add"  layout="column" autoScroll="true" labelWidth="100">
			...
			<aos:fieldset title="用户数据" columnWidth="1" labelWidth="70">
				...
				<aos:datefield name="pay_date" fieldLabel="缴费截止日期"
					format="Y-m-d H:i:s" editable="true" />
	...
	<aos:window id="_w_update_data" title="修改设备"    resizable="true" maximized="true"   height="480"  layout="fit"  modal="false" center="true" maximizable="true" closable="false" >
