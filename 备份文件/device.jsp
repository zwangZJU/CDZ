...
<aos:head title="设备">
	<aos:include lib="ext" />
	<aos:base href="core/device"/>
</aos:head>
<aos:body>
</aos:body>
<aos:onready>
	<aos:viewport layout="fit" >
		<aos:gridpanel id="_datagridpanel" url="listDevice.jhtml" onrender="_datagridpanel_query" onitemdblclick="_w_update_show"  forceFit="false" >
			<aos:docked>
			...
			<aos:selmodel type="checkbox" mode="multi" />
								      			       <aos:column header="序号" hidden="true"  dataIndex="id_"   width="255"  />
			    						      			       ...
			    						      			       <aos:column header="主机电话" dataIndex="host_phone"   width="255" />
			    						      			       ...
			    						      			       <aos:column header="电话2" dataIndex="phone2"   width="255" />
			    						      			       <aos:column header="电话3" dataIndex="phone3"   width="255" />
	...
	<aos:window id="_w_add_data" title="新增设备"  maximized="true"   height="480"   layout="fit" modal="true" center="true" maximizable="true" closable="false" >
		<aos:formpanel id="_f_add"  layout="column" autoScroll="true" labelWidth="100">
			...
			<aos:fieldset title="用户数据" columnWidth="1" labelWidth="70">
				<aos:textfield name="status" fieldLabel="状态" maxLength="255" />
				<aos:textfield name="arrange_withdraw" fieldLabel="布撤防"
					maxLength="255" />
				...
				<aos:textfield name="video_linkage" fieldLabel="视频联动"
					maxLength="255" />
				...
				<aos:datefield name="pay_date" fieldLabel="缴费截止日期"
					format="Y-m-d 00:00:00" editable="true" />
				<aos:datefield name="guarantee_time" fieldLabel="保修截止日期"
					format="Y-m-d 00:00:00" editable="true" />
				...
				<aos:textfield name="police_station" fieldLabel="所属派出所"
					maxLength="255" />
				<aos:textfield name="network" fieldLabel="网络" maxLength="400" />
				<aos:textfield name="police_phone" fieldLabel="派出所电话"
					maxLength="255" />
				<aos:textfield name="host_address" fieldLabel="主机位置" maxLength="255" />
				<aos:datefield name="insatll_date" fieldLabel="安装日期"
					format="Y-m-d 00:00:00" editable="true" />
				<aos:textfield name="code42" fieldLabel="42代码" maxLength="255" />
				<aos:datefield name="withdraw_date" fieldLabel="撤防时间"
					format="Y-m-d 00:00:00" editable="true" />
				<aos:datefield name="arrange_date" fieldLabel="布防时间"
					format="Y-m-d 00:00:00" editable="true" />
				<aos:datefield name="last_date" fieldLabel="最后来信号时间"
					format="Y-m-d 00:00:00" editable="true" />
				...
				<aos:datefield name="prewithdraw_date" fieldLabel="预定撤防时间"
					format="Y-m-d 00:00:00" editable="true" />
				<aos:datefield name="prearrange_date" fieldLabel="预定布防时间"
					format="Y-m-d 00:00:00" editable="true" />
				<aos:textfield name="group_" fieldLabel="组" maxLength="255" />
				<aos:textfield name="entry_clerk" fieldLabel="录入员" maxLength="255" />
				<aos:textfield name="inspection_staff" fieldLabel="巡检人员"
					maxLength="255" />
				<aos:datefield name="downtime" fieldLabel="停机时间"
					format="Y-m-d 00:00:00" editable="true" />
				<aos:textfield name="phone1" fieldLabel="电话1" maxLength="255" />
				<aos:textfield name="phone2" fieldLabel="电话2" maxLength="255" />
				<aos:textfield name="phone3" fieldLabel="电话3" maxLength="255" />
				<aos:textfield name="head_phone2" fieldLabel="负责人电话2"
					maxLength="255" />
				<aos:datefield name="net_date" fieldLabel="入网日期"
					format="Y-m-d 00:00:00" editable="true" />
				<aos:textfield name="communication_line" fieldLabel="通讯线路"
					maxLength="255" />
            ...
            <aos:fieldset title="使用者" columnWidth="1" labelWidth="70">
               <aos:textfield name="users_id" fieldLabel="编号" maxLength="255" />
				...
				<aos:textareafield name="remarks" fieldLabel="备注" columnWidth="1"  />  
			...
			<aos:fieldset title="网络设置" columnWidth="1" labelWidth="70">
				...
				<aos:textfield name="network_setting_substation" fieldLabel="分站"
					maxLength="255" />
				<aos:textfield name="network_setting_name" fieldLabel="名称"
					maxLength="255" />
				<aos:textfield name="network_setting_type" fieldLabel="类型"
					maxLength="255" />
				<aos:textfield name="network_setting_template" fieldLabel="模板文件"
					maxLength="255" />
				<aos:textfield name="network_setting_remarks" fieldLabel="备注"
					maxLength="255" />
				<aos:textfield name="network_setting_number" fieldLabel="接收号码"
					maxLength="255" />
				<aos:textfield name="network_setting_users" fieldLabel="防区使用者"
					maxLength="255" />
	...
	<aos:window id="_w_update_data" title="修改设备"    resizable="true" minimizable="true"   height="480"  layout="fit"  modal="false" center="true" maximizable="true" closable="false" >
	   
			<aos:formpanel id="_f_update"   layout="column" autoScroll="true" labelWidth="100">
              <aos:hiddenfield name="id_"/>
            <aos:fieldset >
                     <aos:textfield name="user_id" fieldLabel="用户编号"  maxLength="255" />  
            </aos:fieldset>
