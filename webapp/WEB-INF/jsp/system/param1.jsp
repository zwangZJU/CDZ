...
<aos:onready>
	<aos:viewport layout="fit">
		<aos:gridpanel id="_g_param" url="masterDataService.listParam1" onrender="_g_param_query"  forceFit="true"
			...
			<aos:docked forceBoder="0 0 1 0" >
				...
				<aos:triggerfield emptyText="会员名称|键|值" id="id_nkv_" onenterkey="_g_param_query"
			...
			<aos:column header="会员名称" dataIndex="name_" celltip="true" width="100" />
			<aos:column header="参数变量" dataIndex="key_" width="100" />
			<aos:column header="参数值" dataIndex="value_" width="100" celltip="true" />
			<aos:column header="说明" dataIndex="remark_" celltip="true" minWidth="200" />
		</aos:gridpanel>
	</aos:viewport>
	...
	<aos:window id="_w_param_u" title="修改参数">
		<aos:formpanel id="_f_param_u" width="500" layout="anchor" labelWidth="65">
			...
			<aos:textfield name="name_" fieldLabel="会员名称" allowBlank="false" disabled="true"  maxLength="50" />
			<aos:textfield name="key_" fieldLabel="参数变量" allowBlank="false" disabled="true" maxLength="50" />
			<aos:textareafield name="value_" fieldLabel="参数值" maxLength="4000" allowBlank="false" height="80" />
			<aos:textareafield fieldLabel="说明" name="remark_" maxLength="2000" height="60" />
		</aos:formpanel>
		<aos:docked dock="bottom" ui="footer">
			<aos:dockeditem xtype="tbfill" />
	...
	<script type="text/javascript">
            ...
            function _f_param_u_submit() {
                AOS.ajax({
                    forms: _f_param_u,
                    url: 'masterDataService.updateParam1',
                    ok: function (data) {
                    	debugger;
                    	if(data.appcode == '1'){
                            _w_param_u.hide();
