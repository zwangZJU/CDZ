...
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:gridpanel id="_g_depositList" url="depositListController.list1DepositList" onrender="_g_depositList_query"
			 region="center">
			<aos:menu>
		...
		<aos:window id="_w_depositList3" title="审核" onshow="_w_depositList3_onshow">
			...
			<aos:docked dock="bottom" ui="footer">
				<aos:dockeditem xtype="tbfill" />
				<aos:dockeditem onclick="_f_depositList3_update" text="确定" icon="ok.png" />
		...
		function _f_depositList3_update(){
			//var status=AOS.getValue('_f_depositList3.status');
				AOS.ajax({
					...
					url : 'depositListController.auditDepositList2',
					ok : function(data) {
						AOS.tip(data.appmsg);
						_g_depositList_store.reload();
						_w_depositList3.hide();
					}
			});
		}
		//修改账户保存
