...
<aos:onready>
	<aos:viewport layout="border">
		<aos:formpanel id="_f_query" layout="column" labelWidth="70" header="false" region="north" border="false">
			...
			<aos:hiddenfield name="oper_id"   value="1" />
			<aos:textfield name="account_" fieldLabel="会员手机号" columnWidth="0.25" />
			<aos:combobox name="status" fieldLabel="申请状态" dicField="depositStatus" columnWidth="0.25" />
		...
		<aos:gridpanel id="_g_depositList" url="depositListController.listDepositList" onrender="_g_depositList_query"
			 region="center">
			<aos:menu>
				...
				<aos:menuitem text="审核" onclick="_g_depositList_audit" icon="ok.png" />
			...
			<aos:docked forceBoder="1 0 1 0">
				<aos:dockeditem xtype="tbtext" text="申请余额退款记录列表" />
				<aos:dockeditem xtype="tbseparator" />
				<aos:dockeditem xtype="tbtext" text="(只支持支付宝退款)" />
				...
				<aos:dockeditem text="审核" icon="ok.png" onclick="_g_depositList_audit" />
			...
			<aos:column header="会员余额【元】" dataIndex="amt" width="80"  />	
			<aos:column header="收款帐号" dataIndex="account" width="100" celltip="true"/>
			<aos:column header="收款姓名" dataIndex="name" width="100" celltip="true"/>
			...
			<aos:column header="退款时间" dataIndex="pay_date" type="date" format="Y-m-d H:i:s" width="150" />	
