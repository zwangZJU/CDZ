...
<aos:onready>
	<aos:viewport layout="border" id="viewport">
		<aos:formpanel id="_f_query" layout="column" labelWidth="70" header="false" region="north" border="false">
			...
			<aos:hiddenfield name="type_"  fieldLabel="活动ID" value="5" />
		...
		<%-- 新增窗口 --%>
		<aos:window id="_w_activity" title="新增完善资料送优惠券设置"  layout="fit" autoScroll="true">
			<aos:formpanel id="_f_activity" width="450" layout="anchor" labelWidth="80" fileUpload="true">
			<aos:hiddenfield name="type_" fieldLabel="奖励类型" value="5" />
		...
		<%-- 修改窗口 --%>
		<aos:window id="_w_activity2" title="修改完善资料送优惠券设置" onshow="_w_activity_onshow" layout="fit" autoScroll="true" >
