...
<aos:onready>
	<aos:viewport layout="border" id="viewport">
		<aos:formpanel id="_f_query" layout="column" labelWidth="70" header="false" region="north" border="false">
			...
			<aos:hiddenfield name="type_"  fieldLabel="活动ID" value="1" />
		...
		<aos:gridpanel id="_g_activity" url="activityController.listActivity" onrender="_g_activity_query"
			...
			<aos:column header="奖励类型" dataIndex="type_" rendererField="activity_type"  width="100" />	
		...
		<aos:gridpanel id="_g_activityRule" url="activityRuleController.listActivityRule" onrender="_g_activityRule_query"
			...
			<aos:column header="优惠券金额" dataIndex="award_amt" width="100"  celltip="true"/>	
			<aos:column header="优惠券数量" dataIndex="ar_num" width="100"  celltip="true"/>
		...
		<aos:window id="_w_activityRule" title="新增奖励规则">
			...
			<aos:numberfield name="param" minValue="0.01" maxValue="9999999999" fieldLabel="充值金额"  allowBlank="false" />
			<aos:numberfield name="award_amt"  minValue="0.01" maxValue="9999999999"  fieldLabel="优惠券金额"  allowBlank="false" />
		...
		<%-- 新增窗口 --%>
		<aos:window id="_w_activity" title="新增充满送券奖励"  layout="fit" autoScroll="true">
			<aos:formpanel id="_f_activity" width="450" layout="anchor" labelWidth="70" fileUpload="true">
			<aos:hiddenfield name="type_" fieldLabel="奖励类型" value="1" />
		...
		<%-- 修改窗口 --%>
		<aos:window id="_w_activity2" title="修改充满送券奖励" onshow="_w_activity_onshow" layout="fit" autoScroll="true" >
			<aos:formpanel id="_f_activity2" width="450" layout="anchor" labelWidth="70" fileUpload="true" autoScroll="true">
				<%-- 更新时的隐藏变量(主键) --%>
